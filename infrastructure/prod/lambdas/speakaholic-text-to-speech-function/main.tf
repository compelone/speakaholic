...
resource "aws_lambda_function" "speakaholic_text_to_speech_function" {
  ...
  filename      = "../../../../functions/speakaholic-text-to-speech-function/speakaholic-text-to-speech-function.zip"
  function_name = "speakaholic-text-to-speech-function-production"
  ...
  source_code_hash = filebase64sha256("../../../../functions/speakaholic-text-to-speech-function/speakaholic-text-to-speech-function.zip")
  ...
  tags = {
    "Name"        = "speakaholic-text-to-speech-function"
    "Environment" = "production"
    "IsTerraform" = "true"
  }
}
...
resource "aws_cloudwatch_log_group" "speakaholic_text_to_speech_function" {
  name              = "/aws/lambda/speakaholic-text-to-speech-function"
  retention_in_days = 14
}

# See also the following AWS managed policy: AWSLambdaBasicExecutionRole
resource "aws_iam_policy" "speakaholic_text_to_speech_function" {
  name        = "speakaholic-text-to-speech-function-production"
  path        = "/"
